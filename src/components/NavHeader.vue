      ...
      <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="navbar">
            <div class="navbar-left-container">
              <a href="/">
                <img class="navbar-brand-logo" src="/static/imgs/00017883.jpg" width="100px" height="80px">
              </a>
            </div>
            <div class="navbar-right-container" style="display: flex;">
              <div class="navbar-menu-container">
                <span class="navbar-link" v-text="nickName" v-if="nickName"></span>
                <a href="javascript:void(0)" @click="reModalFlag=true" v-if="!nickName">注册</a>
                <a href="javascript:void(0)" class="navbar-link" @click="loginModalFlag=true" v-if="!nickName">用户登录</a>
          ...
          <div class="md-content">
            <div class="confirm-tips">
              ...
              <ul>
                <li class="regi_form_input">
                  <i class="icon IconPeople"></i>
                  <input type="text" v-model="id" class="regi_login_input regi_login_input_left" placeholder="请输入用户邮箱">
                </li>
                <li class="regi_form_input">
                  <i class="icon IconPeople"></i>
                  <input type="text" v-model="name" class="regi_login_input regi_login_input_left" placeholder="请输入用户名" data-type="loginname">
                </li>
                <li class="regi_form_input noMargin">
                  <i class="icon IconPwd"></i>
                  <input type="password" v-model="pwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="请输入密码">
                </li>
                <li class="regi_form_input noMargin">
                  <i class="icon IconPwd"></i>
                  <input type="password" v-model="twopwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="请确认密码" @keyup.enter="register">
                </li>
              </ul>
            </div>
            <div class="login-wrap">
