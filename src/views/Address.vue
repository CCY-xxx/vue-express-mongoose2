<template>
    <div>
        ...
        <div class="container">
          <div class="checkout-addr">
            <div class="page-title-normal">
              <h2 class="page-title-h2"><span>选择</span></h2>
            </div>
            <!-- process step -->
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  ...
                  <li class="addr-new" @click="isAdd=true">
      ...
      <modal :mdShow="isAdd" @close="closeModal">
        <p slot="message">
          <input type="text" v-model="addressId" placeholder="地址编号">
          <input type="text" v-model="userName" placeholder="用户姓名">
          <input type="text" v-model="streetName" placeholder="街道名">
          <input type="text" v-model="postCode" placeholder="邮政编码">
          <input type="text" v-model="tel" placeholder="电话号码">
          <span>是否设置为默认地址:</span>
          <select name="" v-model="isDefault">
        ...
        <div slot="btnGroup">
          ...
          <a class="btn btn--m btn--red" href="javascript:;" @click="isAdd=false">取消</a>
        </div>
      </modal>
