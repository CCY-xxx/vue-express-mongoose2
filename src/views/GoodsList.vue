          ...
          <div class="accessory-result">
            ...
            <div class="accessory-list-wrap">
              ...
              <div class="accessory-list col-4">
                <ul>
                  <li v-for="(item,index) in goodsList" :key="index" v-if="item.productImage.split('\\')[0]==='upload'">
                    <div class="pic">
                      <a href="#"><img  v-lazy="`/static/${item.productImage}`" :key="item.productImage" alt=""></a>
                    </div>
                    <div class="main">
